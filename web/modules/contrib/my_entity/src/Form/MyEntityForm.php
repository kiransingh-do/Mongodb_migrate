...
class MyEntityForm extends ContentEntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['#theme'] = ['my_entity_form'];
    $form['#attached']['library'][] = 'my_entity/form';
    $changed = $my_entity->getChangedTime();
    $form['changed'] = [
      '#type' => 'hidden',
    ...
    if ($changed) {
      ...
      $last_saved = $my_entity->isNew() ? $this->t('Not saved yet') : $this->t('N/A');
    }
    ...
    $form['meta'] = [
      ...
      'owner' => [
        ...
        '#markup' => '<h4 class="label inline">' . $this->t('Owner') . '</h4> ' . $my_entity->getOwner()->getDisplayName(),
      ],
    ];
    if (isset($form['uid'])) {
    ...
    $form['path_settings'] = [
      ...
      '#group' => 'advanced',
      '#access' => !empty($form['path']['#access']) && $my_entity->get('path')->access('edit'),
      '#attributes' => [
        'class' => ['path-form'],
      ],
      '#attached' => [
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage($this->t('Saved the %label my_entity.', [
